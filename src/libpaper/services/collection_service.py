...
class CollectionService:
  ...
  async def get_collection(self, collection_id: UUID, with_relations: bool = True) -> Optional[Collection]:
    """
    获取分类
  ...
  async def get_root_collections(self, with_relations: bool = True) -> List[Collection]:
    """
    获取根分类（没有父分类的分类）
  ...
  async def get_child_collections(self, parent_id: UUID, with_relations: bool = True) -> List[Collection]:
    """
    获取子分类
