...
from ..utils import format_date, format_size, parse_uuid, truncate_text
...
def list(
    ...
    service = PaperService(db, file_manager)
    ...
    async def _show():
        ...
        try:
            ...
            if paper.publication_date:
                console.print(
                    f"[bold]发表日期:[/bold] {format_date(paper.publication_date)}"
                )
